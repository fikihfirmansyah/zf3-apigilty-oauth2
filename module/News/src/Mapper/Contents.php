 ...
 */
class Contents extends AbstractMapper implements MapperInterface
{
    /**
    ...
    public function getEntityRepository()
    {
        ...
        return $em->getRepository('News\\Entity\\Contents');
    }
    ...
    public function fetchAll(array $params, $order = null, $asc = false)
    {
        ...
        $query->useResultCache(true, 600, 'news_contents_');
