 ...
 */
class ThreadStrategy extends AbstractCollectionStrategy implements StrategyInterface
{
    /**
    ...
    {
        if (!is_null($value) && $value instanceof Thread)
            return [
                'uuid'      => $value->getUuid(),
                'thread_body'      => $value->getThreadBody(),
            ];
